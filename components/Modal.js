    ...
    return (
        <Transition.Root show={open} as={Fragment}>
            <Dialog
                ...
                onClose={setOpen}
            >
                <div className="flex items justify-center min-h-[800px] sm:min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                    <Transition.Child
                        as={Fragment}
                    ...
                    >
                        <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left h-fit sm:min-h-10 mt-[35vh] sm:mt-0
